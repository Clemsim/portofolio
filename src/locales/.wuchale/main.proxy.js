            ...
            const catalogs = {main: {fr: () => import('./main.main.fr.compiled.js'),en: () => import('./main.main.en.compiled.js'),es: () => import('./main.main.es.compiled.js'),de: () => import('./main.main.de.compiled.js')}}
